    ...
    try {
      {
        await addDoc(
          collection(db, "Book_Rooms"),
          {
            ...
            Total_rend:
              Number(room_data.Room_rend) *
              Number(get_Submit_form_data.get("booking_days")),
...
=======
=======
          <Form size="tiny" onSubmit={handleSubmit_bookRoom}>
            <Form.Group widths="equal">
              <Form.Field
...
=======
                ...
                min={Number(room_data.Min_day)}
                max={Number(room_data.Max_day)}
                name="booking_days"
...
=======
            ...
            data.booking_days != "" ? (
              <Message positive >
                ...
                <h5>
                  RoomRend per day{`${Number(room_data.Room_rend)}`} your chose{" "}
                  {`${data.booking_days} X ${Number(room_data.Room_rend)}= ${
                    data.booking_days * Number(room_data.Room_rend)
                  }`}
                </h5>
              </Message>
            ) : (
